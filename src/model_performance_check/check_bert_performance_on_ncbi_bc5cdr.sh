...
bc5cdr_dir=${ner_dir}/corpus/bc5cdr
...
hparam_4="-c 3 --batch-size 4 -e 20 --fine-tune-biobert --lr-biobert 5e-5"
...
python ${ner_dir}/src/modules/ner/train_ner_tagger.py \
   ${use_bc5cdr_disease} \
    ...
    --biobert-path ${model_dir}/tf_bert_hospital_c1p2_1M/pretraining_output_stage1/model.ckpt-100000 \
    ${hparam_4} \
    -v c1p2_1M_bc5cdr_disease_${suffix_4}
...
python ${ner_dir}/src/modules/ner/train_ner_tagger.py \
   ${use_bc5cdr_disease} \
    ...
    --biobert-path ${model_dir}/bert/bert_model.ckpt \
    ${hparam_4} \
    -v general_bc5cdr_disease_${suffix_4}
...
python ${ner_dir}/src/modules/ner/train_ner_tagger.py \
   ${use_bc5cdr_disease} \
    ...
    --biobert-path ${model_dir}/tf_bert_hospital_c0p2_100k/pretraining_output_stage1/model.ckpt-100000 \
    ${hparam_4} \
    -v c0p2_100k_bc5cdr_disease_${suffix_4}
...
python ${ner_dir}/src/modules/ner/train_ner_tagger.py \
   ${use_bc5cdr_chemical} \
    ...
    --biobert-path ${model_dir}/tf_bert_hospital_c1p2_1M/pretraining_output_stage1/model.ckpt-100000 \
    ${hparam_4} \
    -v c1p2_1M_bc5cdr_chemical_${suffix_4}
...
python ${ner_dir}/src/modules/ner/train_ner_tagger.py \
   ${use_bc5cdr_chemical} \
    ...
    --biobert-path ${model_dir}/bert/bert_model.ckpt \
    ${hparam_4} \
    -v general_bc5cdr_chemical_${suffix_4}
...
python ${ner_dir}/src/modules/ner/train_ner_tagger.py \
   ${use_bc5cdr_chemical} \
    ...
    --biobert-path ${model_dir}/tf_bert_hospital_c0p2_100k/pretraining_output_stage1/model.ckpt-100000 \
    ${hparam_4} \
    -v c0p2_100k_bc5cdr_chemical_${suffix_4}
